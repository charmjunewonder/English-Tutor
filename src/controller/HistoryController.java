...
/**
 * A class controls the view which shows the history of the selected lesson.
 * It simply pass the data to view.
 * 
 * @author Eric
 * @version 1.1
...
public class HistoryController {
    ...
    /**
     * Create a new instance of HistoryController 
     * and let view set up the data.
